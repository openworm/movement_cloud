...
CREATE TABLE `experiments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `base_name` varchar(200) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=14465 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `features_means` (
  ...
  `width_length_ratio_foward` double DEFAULT NULL,
  ...
  `head_bend_mean_pos` double DEFAULT NULL,
  `head_bend_mean_foward` double DEFAULT NULL,
  `head_bend_mean_foward_abs` double DEFAULT NULL,
  `head_bend_mean_foward_neg` float DEFAULT NULL,
  `head_bend_mean_foward_pos` double DEFAULT NULL,
  `head_bend_mean_paused` double DEFAULT NULL,
  `head_bend_mean_paused_abs` double DEFAULT NULL,
  `head_bend_mean_paused_neg` float DEFAULT NULL,
  ...
  `head_bend_mean_backward_neg` float DEFAULT NULL,
  ...
  `neck_bend_mean_pos` double DEFAULT NULL,
  `neck_bend_mean_foward` double DEFAULT NULL,
  `neck_bend_mean_foward_abs` double DEFAULT NULL,
  `neck_bend_mean_foward_neg` float DEFAULT NULL,
  `neck_bend_mean_foward_pos` double DEFAULT NULL,
  `neck_bend_mean_paused` double DEFAULT NULL,
  `neck_bend_mean_paused_abs` double DEFAULT NULL,
  `neck_bend_mean_paused_neg` float DEFAULT NULL,
  ...
  `neck_bend_mean_backward_neg` float DEFAULT NULL,
  ...
  `midbody_bend_mean_pos` double DEFAULT NULL,
  `midbody_bend_mean_foward` double DEFAULT NULL,
  `midbody_bend_mean_foward_abs` double DEFAULT NULL,
  `midbody_bend_mean_foward_neg` float DEFAULT NULL,
  `midbody_bend_mean_foward_pos` double DEFAULT NULL,
  `midbody_bend_mean_paused` double DEFAULT NULL,
  `midbody_bend_mean_paused_abs` double DEFAULT NULL,
  `midbody_bend_mean_paused_neg` float DEFAULT NULL,
  ...
  `midbody_bend_mean_backward_neg` float DEFAULT NULL,
  `midbody_bend_mean_backward_pos` double DEFAULT NULL,
  `hips_bend_mean` float DEFAULT NULL,
  `hips_bend_mean_abs` float DEFAULT NULL,
  `hips_bend_mean_neg` double DEFAULT NULL,
  `hips_bend_mean_pos` float DEFAULT NULL,
  `hips_bend_mean_foward` double DEFAULT NULL,
  `hips_bend_mean_foward_abs` double DEFAULT NULL,
  `hips_bend_mean_foward_neg` double DEFAULT NULL,
  `hips_bend_mean_foward_pos` float DEFAULT NULL,
  ...
  `hips_bend_mean_paused_pos` float DEFAULT NULL,
  ...
  `hips_bend_mean_backward_pos` float DEFAULT NULL,
  `tail_bend_mean` float DEFAULT NULL,
  `tail_bend_mean_abs` float DEFAULT NULL,
  `tail_bend_mean_neg` double DEFAULT NULL,
  `tail_bend_mean_pos` float DEFAULT NULL,
  `tail_bend_mean_foward` double DEFAULT NULL,
  `tail_bend_mean_foward_abs` double DEFAULT NULL,
  `tail_bend_mean_foward_neg` double DEFAULT NULL,
  `tail_bend_mean_foward_pos` float DEFAULT NULL,
  ...
  `tail_bend_mean_paused_pos` float DEFAULT NULL,
  ...
  `tail_bend_mean_backward_pos` float DEFAULT NULL,
  `head_bend_sd` float DEFAULT NULL,
  `head_bend_sd_abs` float DEFAULT NULL,
  `head_bend_sd_neg` float DEFAULT NULL,
  `head_bend_sd_pos` double DEFAULT NULL,
  `head_bend_sd_foward` double DEFAULT NULL,
  `head_bend_sd_foward_abs` double DEFAULT NULL,
  `head_bend_sd_foward_neg` float DEFAULT NULL,
  `head_bend_sd_foward_pos` double DEFAULT NULL,
  `head_bend_sd_paused` double DEFAULT NULL,
  `head_bend_sd_paused_abs` double DEFAULT NULL,
  `head_bend_sd_paused_neg` float DEFAULT NULL,
  ...
  `head_bend_sd_backward_neg` float DEFAULT NULL,
  ...
  `neck_bend_sd_pos` double DEFAULT NULL,
  `neck_bend_sd_foward` double DEFAULT NULL,
  `neck_bend_sd_foward_abs` double DEFAULT NULL,
  `neck_bend_sd_foward_neg` float DEFAULT NULL,
  `neck_bend_sd_foward_pos` double DEFAULT NULL,
  `neck_bend_sd_paused` double DEFAULT NULL,
  `neck_bend_sd_paused_abs` double DEFAULT NULL,
  `neck_bend_sd_paused_neg` float DEFAULT NULL,
  ...
  `neck_bend_sd_backward_neg` float DEFAULT NULL,
  ...
  `midbody_bend_sd_pos` double DEFAULT NULL,
  `midbody_bend_sd_foward` double DEFAULT NULL,
  `midbody_bend_sd_foward_abs` double DEFAULT NULL,
  `midbody_bend_sd_foward_neg` float DEFAULT NULL,
  `midbody_bend_sd_foward_pos` double DEFAULT NULL,
  `midbody_bend_sd_paused` double DEFAULT NULL,
  `midbody_bend_sd_paused_abs` double DEFAULT NULL,
  `midbody_bend_sd_paused_neg` float DEFAULT NULL,
  ...
  `midbody_bend_sd_backward_neg` float DEFAULT NULL,
  `midbody_bend_sd_backward_pos` double DEFAULT NULL,
  `hips_bend_sd` float DEFAULT NULL,
  `hips_bend_sd_abs` float DEFAULT NULL,
  `hips_bend_sd_neg` double DEFAULT NULL,
  `hips_bend_sd_pos` float DEFAULT NULL,
  `hips_bend_sd_foward` double DEFAULT NULL,
  `hips_bend_sd_foward_abs` double DEFAULT NULL,
  `hips_bend_sd_foward_neg` double DEFAULT NULL,
  `hips_bend_sd_foward_pos` float DEFAULT NULL,
  ...
  `hips_bend_sd_paused_pos` float DEFAULT NULL,
  ...
  `hips_bend_sd_backward_pos` float DEFAULT NULL,
  `tail_bend_sd` float DEFAULT NULL,
  `tail_bend_sd_abs` float DEFAULT NULL,
  `tail_bend_sd_neg` double DEFAULT NULL,
  `tail_bend_sd_pos` float DEFAULT NULL,
  `tail_bend_sd_foward` double DEFAULT NULL,
  `tail_bend_sd_foward_abs` double DEFAULT NULL,
  `tail_bend_sd_foward_neg` double DEFAULT NULL,
  `tail_bend_sd_foward_pos` float DEFAULT NULL,
  ...
  `tail_bend_sd_paused_pos` float DEFAULT NULL,
  ...
  `primary_wavelength_foward` double DEFAULT NULL,
  ...
  `secondary_wavelength_foward` double DEFAULT NULL,
  ...
  `tail_to_head_orientation_neg` double DEFAULT NULL,
  `tail_to_head_orientation_pos` float DEFAULT NULL,
  `tail_to_head_orientation_foward` double DEFAULT NULL,
  `tail_to_head_orientation_foward_abs` double DEFAULT NULL,
  `tail_to_head_orientation_foward_neg` double DEFAULT NULL,
  `tail_to_head_orientation_foward_pos` float DEFAULT NULL,
  ...
  `tail_to_head_orientation_paused_pos` float DEFAULT NULL,
  ...
  `tail_to_head_orientation_backward_pos` float DEFAULT NULL,
  `head_orientation` float DEFAULT NULL,
  `head_orientation_abs` float DEFAULT NULL,
  `head_orientation_neg` double DEFAULT NULL,
  `head_orientation_pos` float DEFAULT NULL,
  `head_orientation_foward` double DEFAULT NULL,
  `head_orientation_foward_abs` double DEFAULT NULL,
  `head_orientation_foward_neg` double DEFAULT NULL,
  `head_orientation_foward_pos` float DEFAULT NULL,
  ...
  `head_orientation_paused_pos` float DEFAULT NULL,
  ...
  `head_orientation_backward_pos` float DEFAULT NULL,
  `tail_orientation` float DEFAULT NULL,
  `tail_orientation_abs` float DEFAULT NULL,
  `tail_orientation_neg` double DEFAULT NULL,
  `tail_orientation_pos` double DEFAULT NULL,
  `tail_orientation_foward` double DEFAULT NULL,
  `tail_orientation_foward_abs` double DEFAULT NULL,
  `tail_orientation_foward_neg` double DEFAULT NULL,
  `tail_orientation_foward_pos` double DEFAULT NULL,
  ...
  `eigen_projection_1_pos` double DEFAULT NULL,
  `eigen_projection_1_foward` double DEFAULT NULL,
  `eigen_projection_1_foward_abs` double DEFAULT NULL,
  `eigen_projection_1_foward_neg` float DEFAULT NULL,
  `eigen_projection_1_foward_pos` double DEFAULT NULL,
  `eigen_projection_1_paused` double DEFAULT NULL,
  `eigen_projection_1_paused_abs` double DEFAULT NULL,
  `eigen_projection_1_paused_neg` float DEFAULT NULL,
  ...
  `eigen_projection_1_backward_neg` float DEFAULT NULL,
  ...
  `eigen_projection_2_pos` double DEFAULT NULL,
  `eigen_projection_2_foward` double DEFAULT NULL,
  `eigen_projection_2_foward_abs` double DEFAULT NULL,
  `eigen_projection_2_foward_neg` float DEFAULT NULL,
  `eigen_projection_2_foward_pos` double DEFAULT NULL,
  `eigen_projection_2_paused` double DEFAULT NULL,
  `eigen_projection_2_paused_abs` double DEFAULT NULL,
  `eigen_projection_2_paused_neg` float DEFAULT NULL,
  ...
  `eigen_projection_2_backward_neg` float DEFAULT NULL,
  ...
  `eigen_projection_3_neg` double DEFAULT NULL,
  `eigen_projection_3_pos` float DEFAULT NULL,
  `eigen_projection_3_foward` double DEFAULT NULL,
  `eigen_projection_3_foward_abs` double DEFAULT NULL,
  `eigen_projection_3_foward_neg` double DEFAULT NULL,
  `eigen_projection_3_foward_pos` float DEFAULT NULL,
  ...
  `eigen_projection_3_paused_pos` float DEFAULT NULL,
  ...
  `eigen_projection_3_backward_pos` float DEFAULT NULL,
  ...
  `eigen_projection_4_foward` double DEFAULT NULL,
  `eigen_projection_4_foward_abs` double DEFAULT NULL,
  `eigen_projection_4_foward_neg` float DEFAULT NULL,
  `eigen_projection_4_foward_pos` float DEFAULT NULL,
  `eigen_projection_4_paused` double DEFAULT NULL,
  `eigen_projection_4_paused_abs` double DEFAULT NULL,
  `eigen_projection_4_paused_neg` float DEFAULT NULL,
  `eigen_projection_4_paused_pos` float DEFAULT NULL,
  `eigen_projection_4_backward` double DEFAULT NULL,
  `eigen_projection_4_backward_abs` double DEFAULT NULL,
  `eigen_projection_4_backward_neg` float DEFAULT NULL,
  `eigen_projection_4_backward_pos` float DEFAULT NULL,
  ...
  `eigen_projection_5_foward` double DEFAULT NULL,
  `eigen_projection_5_foward_abs` double DEFAULT NULL,
  `eigen_projection_5_foward_neg` float DEFAULT NULL,
  `eigen_projection_5_foward_pos` float DEFAULT NULL,
  `eigen_projection_5_paused` double DEFAULT NULL,
  `eigen_projection_5_paused_abs` double DEFAULT NULL,
  `eigen_projection_5_paused_neg` float DEFAULT NULL,
  `eigen_projection_5_paused_pos` float DEFAULT NULL,
  `eigen_projection_5_backward` double DEFAULT NULL,
  `eigen_projection_5_backward_abs` double DEFAULT NULL,
  `eigen_projection_5_backward_neg` float DEFAULT NULL,
  `eigen_projection_5_backward_pos` float DEFAULT NULL,
  ...
  `eigen_projection_6_foward` double DEFAULT NULL,
  `eigen_projection_6_foward_abs` double DEFAULT NULL,
  `eigen_projection_6_foward_neg` float DEFAULT NULL,
  `eigen_projection_6_foward_pos` float DEFAULT NULL,
  `eigen_projection_6_paused` double DEFAULT NULL,
  `eigen_projection_6_paused_abs` double DEFAULT NULL,
  `eigen_projection_6_paused_neg` float DEFAULT NULL,
  `eigen_projection_6_paused_pos` float DEFAULT NULL,
  `eigen_projection_6_backward` double DEFAULT NULL,
  `eigen_projection_6_backward_abs` double DEFAULT NULL,
  `eigen_projection_6_backward_neg` float DEFAULT NULL,
  `eigen_projection_6_backward_pos` float DEFAULT NULL,
  ...
  `head_tip_speed_foward` double DEFAULT NULL,
  `head_tip_speed_foward_abs` double DEFAULT NULL,
  `head_tip_speed_foward_neg` float DEFAULT NULL,
  `head_tip_speed_foward_pos` float DEFAULT NULL,
  `head_tip_speed_paused` double DEFAULT NULL,
  `head_tip_speed_paused_abs` double DEFAULT NULL,
  `head_tip_speed_paused_neg` float DEFAULT NULL,
  `head_tip_speed_paused_pos` float DEFAULT NULL,
  `head_tip_speed_backward` double DEFAULT NULL,
  `head_tip_speed_backward_abs` double DEFAULT NULL,
  `head_tip_speed_backward_neg` float DEFAULT NULL,
  `head_tip_speed_backward_pos` float DEFAULT NULL,
  ...
  `head_speed_foward` double DEFAULT NULL,
  `head_speed_foward_abs` double DEFAULT NULL,
  `head_speed_foward_neg` float DEFAULT NULL,
  `head_speed_foward_pos` float DEFAULT NULL,
  `head_speed_paused` double DEFAULT NULL,
  `head_speed_paused_abs` double DEFAULT NULL,
  `head_speed_paused_neg` float DEFAULT NULL,
  `head_speed_paused_pos` float DEFAULT NULL,
  `head_speed_backward` double DEFAULT NULL,
  `head_speed_backward_abs` double DEFAULT NULL,
  `head_speed_backward_neg` float DEFAULT NULL,
  `head_speed_backward_pos` float DEFAULT NULL,
  `midbody_speed` float DEFAULT NULL,
  `midbody_speed_abs` float DEFAULT NULL,
  `midbody_speed_neg` double DEFAULT NULL,
  `midbody_speed_pos` float DEFAULT NULL,
  `midbody_speed_foward` double DEFAULT NULL,
  `midbody_speed_foward_abs` double DEFAULT NULL,
  `midbody_speed_foward_neg` double DEFAULT NULL,
  `midbody_speed_foward_pos` float DEFAULT NULL,
  ...
  `midbody_speed_paused_pos` float DEFAULT NULL,
  ...
  `midbody_speed_backward_pos` float DEFAULT NULL,
  `tail_speed` float DEFAULT NULL,
  `tail_speed_abs` float DEFAULT NULL,
  `tail_speed_neg` double DEFAULT NULL,
  `tail_speed_pos` float DEFAULT NULL,
  `tail_speed_foward` double DEFAULT NULL,
  `tail_speed_foward_abs` double DEFAULT NULL,
  `tail_speed_foward_neg` double DEFAULT NULL,
  `tail_speed_foward_pos` float DEFAULT NULL,
  `tail_speed_paused` double DEFAULT NULL,
  `tail_speed_paused_abs` double DEFAULT NULL,
  `tail_speed_paused_neg` double DEFAULT NULL,
  `tail_speed_paused_pos` float DEFAULT NULL,
  ...
  `tail_speed_backward_pos` float DEFAULT NULL,
  ...
  `tail_tip_speed_foward` double DEFAULT NULL,
  `tail_tip_speed_foward_abs` double DEFAULT NULL,
  `tail_tip_speed_foward_neg` float DEFAULT NULL,
  `tail_tip_speed_foward_pos` float DEFAULT NULL,
  `tail_tip_speed_paused` double DEFAULT NULL,
  `tail_tip_speed_paused_abs` double DEFAULT NULL,
  `tail_tip_speed_paused_neg` float DEFAULT NULL,
  `tail_tip_speed_paused_pos` float DEFAULT NULL,
  `tail_tip_speed_backward` double DEFAULT NULL,
  `tail_tip_speed_backward_abs` double DEFAULT NULL,
  `tail_tip_speed_backward_neg` float DEFAULT NULL,
  `tail_tip_speed_backward_pos` float DEFAULT NULL,
  ...
  `head_tip_motion_direction_foward` double DEFAULT NULL,
  `head_tip_motion_direction_foward_abs` double DEFAULT NULL,
  `head_tip_motion_direction_foward_neg` float DEFAULT NULL,
  `head_tip_motion_direction_foward_pos` float DEFAULT NULL,
  `head_tip_motion_direction_paused` double DEFAULT NULL,
  `head_tip_motion_direction_paused_abs` double DEFAULT NULL,
  `head_tip_motion_direction_paused_neg` float DEFAULT NULL,
  `head_tip_motion_direction_paused_pos` float DEFAULT NULL,
  `head_tip_motion_direction_backward` double DEFAULT NULL,
  `head_tip_motion_direction_backward_abs` double DEFAULT NULL,
  `head_tip_motion_direction_backward_neg` float DEFAULT NULL,
  `head_tip_motion_direction_backward_pos` float DEFAULT NULL,
  ...
  `head_motion_direction_foward` double DEFAULT NULL,
  `head_motion_direction_foward_abs` double DEFAULT NULL,
  `head_motion_direction_foward_neg` float DEFAULT NULL,
  `head_motion_direction_foward_pos` float DEFAULT NULL,
  `head_motion_direction_paused` double DEFAULT NULL,
  `head_motion_direction_paused_abs` double DEFAULT NULL,
  `head_motion_direction_paused_neg` float DEFAULT NULL,
  `head_motion_direction_paused_pos` float DEFAULT NULL,
  `head_motion_direction_backward` double DEFAULT NULL,
  `head_motion_direction_backward_abs` double DEFAULT NULL,
  `head_motion_direction_backward_neg` float DEFAULT NULL,
  `head_motion_direction_backward_pos` float DEFAULT NULL,
  ...
  `midbody_motion_direction_foward` double DEFAULT NULL,
  `midbody_motion_direction_foward_abs` double DEFAULT NULL,
  `midbody_motion_direction_foward_neg` float DEFAULT NULL,
  `midbody_motion_direction_foward_pos` float DEFAULT NULL,
  `midbody_motion_direction_paused` double DEFAULT NULL,
  `midbody_motion_direction_paused_abs` double DEFAULT NULL,
  `midbody_motion_direction_paused_neg` float DEFAULT NULL,
  `midbody_motion_direction_paused_pos` float DEFAULT NULL,
  `midbody_motion_direction_backward` double DEFAULT NULL,
  `midbody_motion_direction_backward_abs` double DEFAULT NULL,
  `midbody_motion_direction_backward_neg` float DEFAULT NULL,
  `midbody_motion_direction_backward_pos` float DEFAULT NULL,
  ...
  `tail_motion_direction_foward` double DEFAULT NULL,
  `tail_motion_direction_foward_abs` double DEFAULT NULL,
  `tail_motion_direction_foward_neg` float DEFAULT NULL,
  `tail_motion_direction_foward_pos` float DEFAULT NULL,
  `tail_motion_direction_paused` double DEFAULT NULL,
  `tail_motion_direction_paused_abs` double DEFAULT NULL,
  `tail_motion_direction_paused_neg` float DEFAULT NULL,
  `tail_motion_direction_paused_pos` float DEFAULT NULL,
  `tail_motion_direction_backward` double DEFAULT NULL,
  `tail_motion_direction_backward_abs` double DEFAULT NULL,
  `tail_motion_direction_backward_neg` float DEFAULT NULL,
  `tail_motion_direction_backward_pos` float DEFAULT NULL,
  ...
  `tail_tip_motion_direction_foward` double DEFAULT NULL,
  `tail_tip_motion_direction_foward_abs` double DEFAULT NULL,
  `tail_tip_motion_direction_foward_neg` float DEFAULT NULL,
  `tail_tip_motion_direction_foward_pos` float DEFAULT NULL,
  `tail_tip_motion_direction_paused` double DEFAULT NULL,
  `tail_tip_motion_direction_paused_abs` double DEFAULT NULL,
  `tail_tip_motion_direction_paused_neg` float DEFAULT NULL,
  `tail_tip_motion_direction_paused_pos` float DEFAULT NULL,
  `tail_tip_motion_direction_backward` double DEFAULT NULL,
  `tail_tip_motion_direction_backward_abs` double DEFAULT NULL,
  `tail_tip_motion_direction_backward_neg` float DEFAULT NULL,
  `tail_tip_motion_direction_backward_pos` float DEFAULT NULL,
  ...
  `foraging_amplitude_foward` double DEFAULT NULL,
  `foraging_amplitude_foward_abs` double DEFAULT NULL,
  `foraging_amplitude_foward_neg` float DEFAULT NULL,
  `foraging_amplitude_foward_pos` float DEFAULT NULL,
  `foraging_amplitude_paused` double DEFAULT NULL,
  `foraging_amplitude_paused_abs` double DEFAULT NULL,
  `foraging_amplitude_paused_neg` float DEFAULT NULL,
  `foraging_amplitude_paused_pos` float DEFAULT NULL,
  `foraging_amplitude_backward` double DEFAULT NULL,
  `foraging_amplitude_backward_abs` double DEFAULT NULL,
  `foraging_amplitude_backward_neg` float DEFAULT NULL,
  `foraging_amplitude_backward_pos` float DEFAULT NULL,
  ...
  `foraging_speed_foward` double DEFAULT NULL,
  `foraging_speed_foward_abs` double DEFAULT NULL,
  `foraging_speed_foward_neg` float DEFAULT NULL,
  `foraging_speed_foward_pos` float DEFAULT NULL,
  `foraging_speed_paused` double DEFAULT NULL,
  `foraging_speed_paused_abs` double DEFAULT NULL,
  `foraging_speed_paused_neg` float DEFAULT NULL,
  `foraging_speed_paused_pos` float DEFAULT NULL,
  `foraging_speed_backward` double DEFAULT NULL,
  `foraging_speed_backward_abs` double DEFAULT NULL,
  `foraging_speed_backward_neg` float DEFAULT NULL,
  `foraging_speed_backward_pos` float DEFAULT NULL,
  `head_crawling_amplitude` double DEFAULT NULL,
  `head_crawling_amplitude_abs` double DEFAULT NULL,
  `head_crawling_amplitude_neg` double DEFAULT NULL,
  `head_crawling_amplitude_pos` double DEFAULT NULL,
  `head_crawling_amplitude_foward` double DEFAULT NULL,
  `head_crawling_amplitude_foward_abs` double DEFAULT NULL,
  `head_crawling_amplitude_foward_neg` double DEFAULT NULL,
  `head_crawling_amplitude_foward_pos` double DEFAULT NULL,
  ...
  `midbody_crawling_amplitude` double DEFAULT NULL,
  `midbody_crawling_amplitude_abs` double DEFAULT NULL,
  `midbody_crawling_amplitude_neg` double DEFAULT NULL,
  `midbody_crawling_amplitude_pos` double DEFAULT NULL,
  `midbody_crawling_amplitude_foward` double DEFAULT NULL,
  `midbody_crawling_amplitude_foward_abs` double DEFAULT NULL,
  `midbody_crawling_amplitude_foward_neg` double DEFAULT NULL,
  `midbody_crawling_amplitude_foward_pos` double DEFAULT NULL,
  ...
  `tail_crawling_amplitude` double DEFAULT NULL,
  `tail_crawling_amplitude_abs` double DEFAULT NULL,
  `tail_crawling_amplitude_neg` double DEFAULT NULL,
  `tail_crawling_amplitude_pos` double DEFAULT NULL,
  `tail_crawling_amplitude_foward` double DEFAULT NULL,
  `tail_crawling_amplitude_foward_abs` double DEFAULT NULL,
  `tail_crawling_amplitude_foward_neg` double DEFAULT NULL,
  `tail_crawling_amplitude_foward_pos` double DEFAULT NULL,
  ...
  `head_crawling_frequency` double DEFAULT NULL,
  `head_crawling_frequency_abs` double DEFAULT NULL,
  `head_crawling_frequency_neg` double DEFAULT NULL,
  `head_crawling_frequency_pos` double DEFAULT NULL,
  `head_crawling_frequency_foward` double DEFAULT NULL,
  `head_crawling_frequency_foward_abs` double DEFAULT NULL,
  `head_crawling_frequency_foward_neg` double DEFAULT NULL,
  `head_crawling_frequency_foward_pos` double DEFAULT NULL,
  ...
  `midbody_crawling_frequency` double DEFAULT NULL,
  `midbody_crawling_frequency_abs` double DEFAULT NULL,
  `midbody_crawling_frequency_neg` double DEFAULT NULL,
  `midbody_crawling_frequency_pos` double DEFAULT NULL,
  `midbody_crawling_frequency_foward` double DEFAULT NULL,
  `midbody_crawling_frequency_foward_abs` double DEFAULT NULL,
  `midbody_crawling_frequency_foward_neg` double DEFAULT NULL,
  `midbody_crawling_frequency_foward_pos` double DEFAULT NULL,
  ...
  `tail_crawling_frequency` double DEFAULT NULL,
  `tail_crawling_frequency_abs` double DEFAULT NULL,
  `tail_crawling_frequency_neg` double DEFAULT NULL,
  `tail_crawling_frequency_pos` double DEFAULT NULL,
  `tail_crawling_frequency_foward` double DEFAULT NULL,
  `tail_crawling_frequency_foward_abs` double DEFAULT NULL,
  `tail_crawling_frequency_foward_neg` double DEFAULT NULL,
  `tail_crawling_frequency_foward_pos` double DEFAULT NULL,
  ...
  `path_range_foward` double DEFAULT NULL,
  ...
  `path_curvature_foward` double DEFAULT NULL,
  `path_curvature_foward_abs` double DEFAULT NULL,
  `path_curvature_foward_neg` float DEFAULT NULL,
  `path_curvature_foward_pos` float DEFAULT NULL,
  `path_curvature_paused` double DEFAULT NULL,
  `path_curvature_paused_abs` double DEFAULT NULL,
  `path_curvature_paused_neg` float DEFAULT NULL,
  `path_curvature_paused_pos` float DEFAULT NULL,
  `path_curvature_backward` double DEFAULT NULL,
  `path_curvature_backward_abs` double DEFAULT NULL,
  `path_curvature_backward_neg` float DEFAULT NULL,
  `path_curvature_backward_pos` float DEFAULT NULL,
  ...
  `forward_time` double DEFAULT NULL,
  `forward_distance` double DEFAULT NULL,
  `inter_forward_time` double DEFAULT NULL,
  `inter_forward_distance` double DEFAULT NULL,
  `forward_motion_frequency` double DEFAULT NULL,
  `forward_motion_time_ratio` double DEFAULT NULL,
  `forward_motion_distance_ratio` double DEFAULT NULL,
  ...
  UNIQUE KEY `experiment_id_2` (`experiment_id`),
  UNIQUE KEY `experiment_id_3` (`experiment_id`)
...
--
-- Table structure for table `progress_analysis`
--

DROP TABLE IF EXISTS `progress_analysis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `progress_analysis` (
  `experiment_id` int(11) NOT NULL,
  `exit_flag_id` int(11) NOT NULL,
  `mask_file` varchar(700) DEFAULT NULL,
  `skeletons_file` varchar(700) DEFAULT NULL,
  `features_file` varchar(700) DEFAULT NULL,
  ...
  CONSTRAINT `progress_analysis_ibfk_1` FOREIGN KEY (`experiment_id`) REFERENCES `experiments` (`id`),
  CONSTRAINT `progress_analysis_ibfk_2` FOREIGN KEY (`exit_flag_id`) REFERENCES `exit_flags` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `segworm_comparisons` (
  ...
  CONSTRAINT `segworm_comparisons_ibfk_2` FOREIGN KEY (`segworm_feature_id`) REFERENCES `segworm_features` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `segworm_features`
--

DROP TABLE IF EXISTS `segworm_features`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `segworm_features` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `experiment_id` (`experiment_id`),
  CONSTRAINT `segworm_features_ibfk_1` FOREIGN KEY (`experiment_id`) REFERENCES `experiments` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

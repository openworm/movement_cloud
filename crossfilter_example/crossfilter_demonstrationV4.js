...
function create_crossfilter(data_rows) {
    ...
    var dates = date.group(d3.timeDay); // date group
    dates.groupId = "dates";
    ...
    */
    ...
    d3.selectAll("input[type=checkbox][name=days]")
        .properties("checked", function(d, i, a) {
            var elem = d3.select(this);
            var day = elem.properties("value");
            return days[day].state;
        })
        .on("change", function() {
            var elem = d3.select(this);
            var checked = elem.properties("checked");
            var day = elem.properties("value");
    ...
    function updateDaySelection() {
        ...
        d3.selectAll("input[type=radio][value=" + dayType + "]").properties("checked", true);
    ...
    var charts = [
        ...
        .dimension(date)
        .group(dates)
        .round(d3.timeDay.round) // ensures whole days
        .x(d3.scaleTime()

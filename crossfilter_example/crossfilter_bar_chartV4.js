...
function barChart() {
    ...
    var margin = {
        ...
        x,
        y = d3.scaleLinear().range([100, 0]), // 100 pixels height
        id = barChart.id++,
        axis = d3.axisBottom(),
        brush = d3.brush(),
        brushDirty,
    ...
    // BoE: the d3 rebind function moves the "on" method from the "brush"
    // object/function to the "chart" object/function;
    // it then returns the "chart" function/object
    chart.on = function() {
        var value = brush.on.apply(brush, arguments);
